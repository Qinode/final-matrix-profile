...
class TestMP(object):
    def test_naive(self):
        ...
        assert np.allclose(mp, mp_test, atol=1e-04)
    ...
    @pytest.mark.skip(reasone="The profile index from MATLAB code has reference to some trivial match and disagree with the stamp implementation in python")
